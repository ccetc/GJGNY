...
class ResettingController extends ParentController
{
    ...
    public function sendEmailAction()
    {
        ...
        if ($user->isPasswordRequestNonExpired($this->container->getParameter('fos_user.resetting.token_ttl'))) {
          $this->setFlash('adminErrorMessage', 'The password for this user has already been requested within the last 24 hours.');
        ...
        $this->setFlash('adminMessage', 'An email has been sent to '.$user->getEmail().'. It contains an link that you must click to reset your password.');
          return new RedirectResponse($this->container->get('router')->generate('fos_user_security_login'));
    ...
    public function resetAction($token)
    {
        ...
        if ($process) {
            ...
            $this->setFlash('adminMessage', 'Your password has successfully been changed.');
