...
class LeadEvent
{
   ...
   *
   * @ORM\Column(name="canWeCallBack", type="boolean", nullable="true")
   */
   ...
   *
   * @ORM\Column(name="lutBulb", type="boolean", nullable="true")
   */
  private $lutBulb;
  /**
   * @var smallint $lutBulbReplace
   *
   * @ORM\Column(name="lutBulbReplace", type="boolean", nullable="true")
   */
  private $lutBulbReplace;
  /**
   * @var smallint $lutLookAtMaterials
   *
   * @ORM\Column(name="lutLookAtMaterials", type="boolean", nullable="true")
   */
  private $lutLookAtMaterials;
  /**
   * @var smallint $lutMaterialsUseful
   *
   * @ORM\Column(name="lutMaterialsUseful", type="boolean", nullable="true")
   */
   ...
   *
   * @ORM\Column(name="lutAssessment", type="boolean", nullable="true")
   */
   ...
   *
   * @ORM\Column(name="lutNewsletter", type="boolean", nullable="true")
   */
   ...
   *
   * @ORM\Column(name="lutCouponMailed", type="boolean", nullable="true")
   */
