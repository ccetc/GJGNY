...
class Lead
{
     ...
     *
     * @ORM\Column(name="reportReceived", type="boolean")
     */
     ...
     *
     * @ORM\Column(name="campaignChoiceVolunteer", type="boolean")
     */
    private $campaignChoiceVolunteer;
    /**
     * @var smallint $campaignChoiceSteward
     *
     * @ORM\Column(name="campaignChoiceSteward", type="boolean")
     */
    private $campaignChoiceSteward;
    /**
     * @var smallint $campaignChoiceEvent
     *
     * @ORM\Column(name="campaignChoiceEvent", type="boolean")
     */
