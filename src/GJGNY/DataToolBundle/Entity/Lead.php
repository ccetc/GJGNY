...
// =============================================================================  
   ...
   *
   * @ORM\Column(name="step2cScheduled", type="boolean", nullable="true")
   */
...
// =============================================================================  
   ...
   *
   * @ORM\Column(name="newsletterChoiceEnergyTips", type="boolean", nullable="true")
   */
  private $newsletterChoiceEnergyTips;
  /**
   * @var smallint $newsletterChoiceEvents
   *
   * @ORM\Column(name="newsletterChoiceEvents", type="boolean", nullable="true")
   */
  private $newsletterChoiceEvents;
  /**
   * @var smallint $newsletterChoiceSavings
   *
   * @ORM\Column(name="newsletterChoiceSavings", type="boolean", nullable="true")
   */
   ...
   *
   * @ORM\Column(name="motivationChoiceComfort", type="boolean", nullable="true")
   */
  private $motivationChoiceComfort;
  /**
   * @var smallint $motivationChoiceMoney
   *
   * @ORM\Column(name="motivationChoiceMoney", type="boolean", nullable="true")
   */
  private $motivationChoiceMoney;
  /**
   * @var smallint $motivationChoiceIndoorAir
   *
   * @ORM\Column(name="motivationChoiceIndoorAir", type="boolean", nullable="true")
   */
  private $motivationChoiceIndoorAir;
  /**
   * @var smallint $motivationChoiceEnvironment
   *
   * @ORM\Column(name="motivationChoiceEnvironment", type="boolean", nullable="true")
   */
...
// =============================================================================
   ...
   *
   * @ORM\Column(name="financeChoiceGJGNY", type="boolean", nullable="true")
   */
  private $financeChoiceGJGNY;
  /**
   * @var smallint $financeChoiceHomeEquity
   *
   * @ORM\Column(name="financeChoiceHomeEquity", type="boolean", nullable="true")
   */
  private $financeChoiceHomeEquity;
  /**
   * @var smallint $financeChoicePocket
   *
   * @ORM\Column(name="financeChoicePocket", type="boolean", nullable="true")
   */
  private $financeChoicePocket;
  /**
   * @var smallint $financeChoicePersonal
   *
   * @ORM\Column(name="financeChoicePersonal", type="boolean", nullable="true")
   */
   ...
   *
   * @ORM\Column(name="hasCentralAC", type="boolean", nullable="true")
   */
