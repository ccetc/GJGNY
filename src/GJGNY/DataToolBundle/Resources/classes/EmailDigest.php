...
class EmailDigest
{
    ...
    private function sendLeadsToCallEmail($mailer, $toAddress, $fromAddress, $count, $county)
    {
        ...
        $message = \Swift_Message::newInstance()
               ...
               <a href="http://gjgny.ccext.net/admin/gjgny/datatool/lead/list?filter[leadStatus][value]=need+to+call&filter[leadStatus][type]=">http://gjgny.ccext.net/admin/gjgny/datatool/lead/list?filter[leadStatus][value]=need+to+call7filter[leadStatus][type]=</a></html>')
        ;
        $mailer->send($message);
    }
